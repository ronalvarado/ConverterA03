namespace Conversor_A
{
	partial class frmAulas
	{
		...
		{
			this.grbEdiciondeAulas = new System.Windows.Forms.GroupBox();
			...
			this.grbEdiciondeAulas.SuspendLayout();
			...
			// grbEdiciondeAulas
			// 
			this.grbEdiciondeAulas.BackColor = System.Drawing.Color.Transparent;
			this.grbEdiciondeAulas.Controls.Add(this.btnBuscar);
			this.grbEdiciondeAulas.Controls.Add(this.btnEliminar);
			this.grbEdiciondeAulas.Controls.Add(this.btnModificar);
			this.grbEdiciondeAulas.Controls.Add(this.btnNuevo);
			this.grbEdiciondeAulas.ForeColor = System.Drawing.SystemColors.ButtonFace;
			this.grbEdiciondeAulas.Location = new System.Drawing.Point(334, 12);
			this.grbEdiciondeAulas.Name = "grbEdiciondeAulas";
			this.grbEdiciondeAulas.Size = new System.Drawing.Size(71, 144);
			this.grbEdiciondeAulas.TabIndex = 28;
			this.grbEdiciondeAulas.TabStop = false;
			this.grbEdiciondeAulas.Text = "Edición de Aulas";
			// 
			// btnBuscar
			// 
			...
			this.grbNavegacion.TabIndex = 27;
			...
			// grbAula
			// 
			this.grbAula.BackColor = System.Drawing.Color.Transparent;
			this.grbAula.Controls.Add(this.lblAula);
			this.grbAula.Controls.Add(this.txtAula);
			this.grbAula.Controls.Add(this.lblidAula);
			this.grbAula.Enabled = false;
			this.grbAula.ForeColor = System.Drawing.SystemColors.ButtonFace;
			this.grbAula.Location = new System.Drawing.Point(12, 12);
			this.grbAula.Name = "grbAula";
			this.grbAula.Size = new System.Drawing.Size(316, 81);
			this.grbAula.TabIndex = 26;
			this.grbAula.TabStop = false;
			this.grbAula.Text = "Mantenimiento Aulas";
			// 
			// lblAula
			// 
			this.lblAula.AutoSize = true;
			this.lblAula.Location = new System.Drawing.Point(3, 35);
			...
			// txtAula
			// 
			this.txtAula.Location = new System.Drawing.Point(56, 32);
			this.txtAula.Name = "txtAula";
			this.txtAula.Size = new System.Drawing.Size(255, 20);
			this.txtAula.TabIndex = 6;
			// 
			// lblidAula
			// 
			this.lblidAula.AutoSize = true;
			this.lblidAula.Location = new System.Drawing.Point(278, 16);
		...
		private System.Windows.Forms.GroupBox grbEdiciondeAulas;
