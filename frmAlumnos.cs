	...
	public partial class frmAlumnos : Form
	{
		...
		private void btnNuevo_Click(object sender, EventArgs e)
		{
			...
			{ //boton de guardar
				...
				objConexion.mantenimiento_datos_Alumnos(valores, accion);
				actualizarDs();
				posicion = tbl.Rows.Count - 1;
				mostrarDatos();
		...
		{
			if (MessageBox.Show("Esta seguro de elimina a " + txtNombre.Text, "Registro de Alumnos",
			  MessageBoxButtons.YesNo, MessageBoxIcon.Error) == DialogResult.Yes)
			{
				String[] valores = { lblIdAlumno.Text };
				objConexion.mantenimiento_datos_Alumnos(valores, "eliminar");
