	...
	public partial class frmMaterias : Form
	{
		...
		private void btnNuevo_Click(object sender, EventArgs e)
		{
			...
			{ //boton de guardar
				...
				objConexion.mantenimiento_datos_Materias(valores, accion);
				actualizarDs();
				posicion = tbl.Rows.Count - 1;
				mostrarDatos();
		...
		{
			if (MessageBox.Show("Esta seguro de elimina a " + txtMateria.Text, "Registro de Masterias",
			  MessageBoxButtons.YesNo, MessageBoxIcon.Error) == DialogResult.Yes)
			{
				String[] valores = { lblIdMateria.Text };
				objConexion.mantenimiento_datos_Materias(valores, "eliminar");
