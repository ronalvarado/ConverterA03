namespace Conversor_A
{
	partial class frmTrimestres
	{
		...
		{
			this.grbEdiciondeTrimestres = new System.Windows.Forms.GroupBox();
			...
			this.grbTrimestres = new System.Windows.Forms.GroupBox();
			this.lblTrimestre = new System.Windows.Forms.Label();
			this.txtTrimestre = new System.Windows.Forms.TextBox();
			this.lblidTrimestre = new System.Windows.Forms.Label();
			this.grbEdiciondeTrimestres.SuspendLayout();
			this.grbNavegacion.SuspendLayout();
			this.grbTrimestres.SuspendLayout();
			this.SuspendLayout();
			// 
			// grbEdiciondeTrimestres
			// 
			this.grbEdiciondeTrimestres.BackColor = System.Drawing.Color.Transparent;
			this.grbEdiciondeTrimestres.Controls.Add(this.btnBuscar);
			...
			this.grbEdiciondeTrimestres.TabIndex = 25;
			this.grbEdiciondeTrimestres.TabStop = false;
			this.grbEdiciondeTrimestres.Text = "Edición de Trimestres";
			// 
			// btnBuscar
			// 
			...
			// grbTrimestres
			// 
			this.grbTrimestres.BackColor = System.Drawing.Color.Transparent;
			this.grbTrimestres.Controls.Add(this.lblTrimestre);
			...
			this.grbTrimestres.TabIndex = 23;
			this.grbTrimestres.TabStop = false;
			this.grbTrimestres.Text = "Mantenimiento Trimestres";
			// 
			// lblTrimestre
			// 
			this.lblTrimestre.AutoSize = true;
			this.lblTrimestre.Location = new System.Drawing.Point(3, 35);
			this.lblTrimestre.Name = "lblTrimestre";
			this.lblTrimestre.Size = new System.Drawing.Size(53, 13);
			this.lblTrimestre.TabIndex = 7;
			this.lblTrimestre.Text = "Trimestre:";
			// 
			// txtTrimestre
			// 
			this.txtTrimestre.Location = new System.Drawing.Point(56, 32);
			this.txtTrimestre.Name = "txtTrimestre";
			this.txtTrimestre.Size = new System.Drawing.Size(255, 20);
			this.txtTrimestre.TabIndex = 6;
			// 
			// lblidTrimestre
			// 
			this.lblidTrimestre.AutoSize = true;
			this.lblidTrimestre.Location = new System.Drawing.Point(278, 16);
			this.lblidTrimestre.Name = "lblidTrimestre";
			this.lblidTrimestre.Size = new System.Drawing.Size(21, 13);
			this.lblidTrimestre.TabIndex = 1;
			this.lblidTrimestre.Text = "ID:";
			// 
			// frmTrimestres
			// 
			...
			this.Controls.Add(this.grbTrimestres);
			this.Name = "frmTrimestres";
			this.Text = "frmTrimestres";
			this.Load += new System.EventHandler(this.frmTrimestres_Load);
			this.grbEdiciondeTrimestres.ResumeLayout(false);
			this.grbNavegacion.ResumeLayout(false);
			this.grbNavegacion.PerformLayout();
			this.grbTrimestres.ResumeLayout(false);
			this.grbTrimestres.PerformLayout();
		...
		private System.Windows.Forms.GroupBox grbEdiciondeTrimestres;
		...
		private System.Windows.Forms.GroupBox grbTrimestres;
		private System.Windows.Forms.Label lblTrimestre;
		private System.Windows.Forms.TextBox txtTrimestre;
		private System.Windows.Forms.Label lblidTrimestre;
	}
}