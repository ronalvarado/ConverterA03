...
{
	partial class Mantenimiento_de__Responsables
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Mantenimiento_de__Responsables));
			...
			this.Name = "Mantenimiento_de__Responsables";
			this.Text = "Mantenimiento_de_Responsables";
			this.Load += new System.EventHandler(this.Mantenimiento_de__Responsables_Load);
